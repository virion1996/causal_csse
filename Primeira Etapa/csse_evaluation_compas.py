#Experiment that assesses CSSE's performance in the search for counterfactuals with minimal changes to the original instance with Compas dataset
...
def main():
    ...
    # Read Dataset Compas
    df = prepare_compas_dataset("compas-scores-two-years.csv", "/data/")
